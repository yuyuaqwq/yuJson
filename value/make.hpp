...
using enable_if_any_of_t = typename std::enable_if_t<std::_Is_any_of_v<std::_Remove_cvref_t<JudgedObjT>, JudgeTypesT...>, RetValT>;
...
template<class T>
using enable_if_str_t = enable_if_any_of_t<T, StringPtr, char*, char[]>;
